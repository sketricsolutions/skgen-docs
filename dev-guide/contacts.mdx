---
title: "Contact ID"
description: "Use contact_id to link conversations to external users across API, SDK, and widget deployments — enable persistent conversation history per contact."
---
...
>**Note:** Please [contact us](mailto:contact@sketricsolutions.com) if you want to remove/reset contactIDs from our system.
