...
description: "Introduction to SketricGen — a no-code AI agent builder for designing, testing, and deploying multi-agent workflows on a visual AgentSpace canvas."
---
...
Start by telling **Max - Agent Builder** what you need in plain language — Max gathers your requirements, suggests apps, and builds the entire workflow on the canvas for you. Or build manually from scratch on the AgentSpace canvas.
