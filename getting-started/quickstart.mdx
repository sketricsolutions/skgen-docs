...
![New space creation](/images/quickstart/new-space.png)
...
![Agent and tool creation](/images/quickstart/lina-tool.gif)
...
![Knowledge base Website Crawl](/images/quickstart/kb-crawl.png)
...
![Final Result with Handoff](/images/quickstart/final_result.png)
...
![Structured Input](/images/quickstart/structured_input.png)
...
![Test and Show Traces](/images/quickstart/test_traces.png)

---

## 6) Design the widget & publish

![Widget Design](/images/quickstart/design_widget.png)
...
![Publish Workflow](/images/quickstart/publish_agent.png)
