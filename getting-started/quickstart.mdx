---
title: "Quickstart"
description: "Build and deploy a two-agent AI workflow in under 5 minutes — create agents, add tools, configure handoffs, test, and publish a web widget."
icon: "rocket"
keywords: ["quickstart", "AI workflow", "multi-agent", "deploy widget", "handoffs", "no-code"]
---
...
<iframe
  ...
  title="SketricGen Quickstart Video"
...
* **Instructions (paste & tweak — or enhance with AI):**
...
![Screenshot showing the AgentSpace with Lina and Alex agents connected by a handoff edge](/images/quickstart/final_result.png)
...
2. Make sure the workflow is set to **Public** (required for web widget deployment).
3. **Publish (top right in playground) → Chat Bubble**
4. Copy the snippet or follow CMS steps (WordPress, Wix, etc.).
5. Paste into a page on your site and verify.
