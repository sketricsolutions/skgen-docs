...
- **Nodes = Agents.** Each node represents a role or capability.
- **Edges = Handoffs.** Define how one agent passes control or data to another.
...
![](/images/core-concepts/core_agent_space.png)
...
![](/images/core-concepts/core_agent.png)
...
| **API Request**             | Call external REST or GraphQL APIs with headers, auth, and schema mapping. | Integrate internal systems or external SaaS APIs.      |
...
![](/images/core-concepts/core_tools.png)
...
![](/images/core-concepts/core_handoff.png)
...
![](/images/core-concepts/core_structured_output.png)

![](/images/core-concepts/core_structured_input.png)
...
![](/images/core-concepts/core_trace.png)
