---
title: "Core Concepts"
description: "Learn the core building blocks of SketricGen: AgentSpace canvas, AI agents, tools, handoffs, structured I/O, and traces for multi-agent orchestration."
---
