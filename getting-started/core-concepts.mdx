---
title: "Core Concepts"
description: "Learn the core building blocks of SketricGen: AgentSpace, AI agents, tools, handoffs, structured I/O, and traces for multi-agent orchestration."
icon: "puzzle"
keywords: ["core concepts", "AgentSpace", "agents", "tools", "handoffs", "multi-agent orchestration"]
---
...
![Handoff configuration interface showing AI-routed and forced handoff options](/images/core-concepts/core_handoff.png)
...
![Edit Agent Advanced Mode with Structured Data — Input Schema and Output Schema](/images/core-concepts/core_structured_data_ui.png)

![Configure Structured Output (JSON) modal with schema name and fields](/images/core-concepts/core_structure_data_setup.png)
