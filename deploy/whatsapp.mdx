<Tabs>
  <Tab title="Add New Number">
    Integrating WhatsApp with SketricGen enables your custom agent workflow to engage directly with customers through WhatsApp, offering a streamlined and efficient solution for managing inquiries and automating responses. This guide will take you through the steps required to link your agent workflow to a WhatsApp number, ensuring smooth and effective customer communication.

    ## **Before You Begin**

    The phone number you connect to SketricGen via WhatsApp can **only** be used by the agent workflow. It will no longer work with the WhatsApp or WhatsApp Business apps.
    ...
    ## **Pre-requisite: Sign Into SketricGen and Set Up Your agent workflow**
    ...
    **Congratulations!** Your WhatsApp account is now successfully connected to **SketricGen**.
    ...
    You’re all set—your agent workflow is now ready to handle all your business inquiries automatically and efficiently.
    </Tab>
  ...
  <Tab title="WhatsApp Existing Business App User">
    ...
    **Congratulations!** Your WhatsApp account is now successfully connected to **SketricGen**. You’re all set—kick back, relax, maybe watch a movie or take a well-deserved nap. From here on out, your agent workflow has everything under control, handling all your business inquiries like a pro.
    </Tab>
</Tabs>
