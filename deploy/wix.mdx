---
title: "Deploy to Wix"
description: "Add a SketricGen AI agent chat widget to your Wix website — step-by-step guide for embedding multi-agent workflow automations."
keywords: ["deploy", "embed", "Wix", "widget", "SketricGen widget"]
---
...
<Tabs>
  ...
  Go to your agent workflow dashboard, click **Publish**, and copy the embed code.  
  **Note**: Ensure your agent workflow is set to **Public**.

  ![Screenshot showing SketricGen dashboard with Publish button and embed code copy option](/images/wix/screenshot1.png)

  ## **Step 3: Embed the agent workflow in Wix**

  ### 1. Log in to your Wix dashboard.  
  ### 2. Select the site where you want the agent workflow.
  ...
  ### 6. Add an **Anchor** and **Pin** the agent workflow widget to make it a floating bubble.

     ![Screenshot showing Wix Anchor and Pin options for floating chat bubble configuration](/images/wix/screenshot5.png)

  ## **Step 4: Test the agent workflow**

  After publishing, test the agent workflow on your live site.

  ![Screenshot showing Wix site with embedded SketricGen floating chat widget](/images/wix/screenshot6.png)

  ✅ **Success!** Your agent workflow is live as a floating bubble on Wix.
  ...
  Make sure everything is working by testing the agent workflow on your live site.

  ![Screenshot showing Wix site with embedded SketricGen iframe widget](/images/wix/screenshot9.png)

  ✅ Done! Your agent workflow is embedded inline in your Wix site.
