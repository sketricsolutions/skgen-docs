<Tabs>
  ...
  After configuring your agent workflow, go to the dashboard and click **Publish** to copy the embed code.

  > **Note:** Make sure your agent workflow is set to **Public** to embed it on your Squarespace site.
  ...
  ## **Step 3: Sign in to your Squarespace account and embed your agent workflow**

  ### 1. Sign in to your Squarespace account and open the dashboard  
  ### 2. Select the site you want to embed the agent workflow on
  ...
  🎉 **Congratulations!** Your agent workflow is now live on Squarespace, ready to serve your visitors with custom responses.
  ...
  🎉 **Congrats!** You've successfully added your SketricGen agent workflow using an iframe.
