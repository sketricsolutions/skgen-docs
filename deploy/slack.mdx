...
After configuring your agent workflow, click the **Connect** button on the Slack integration panel in the **Publish** sidebar.
...
### 1. Open any channel in your Slack workspace and type **@sketricgen** followed by a question related to your agent workflow’s purpose.  
...
### 2. Click on **Add Them**.  
   The agent workflow will then be available in the channel to answer any questions you might have.

## Step 6: Start Chatting

You're all set! The SketricGen agent workflow is now connected and ready to enhance collaboration within your Slack workspace.
