...
After configuring your chatbot, click the **Connect** button on the Slack integration panel in the **Publish** sidebar.

![Connect Slack Integration](/images/slack/screenshot1.png)

## **Step 3: Grant Permissions**

### 1. Grant SketricGen the required permissions to access your Slack account and workspace.

   ![Grant Permissions](/images/slack/screenshot2.png)
...
### 1. If everything is smooth, the **Connect** button in the Slack panel of the Publish sidebar will change to **Manage**.
   ...
   ![Manage Button](/images/slack/screenshot3.png)

### 2. Click on the **Manage** button to view your integration details.

   ![Integration Details](/images/slack/screenshot4.png)

## Step 5: Open Slack and Message Your Bot

### 1. Open any channel in your Slack workspace and type **@sketricgen** followed by a question related to your chatbot’s purpose.  
   Slack will then prompt you to either invite the bot to the channel or take no action.

   ![Mention Bot in Slack](/images/slack/screenshot5.png)

### 2. Click on **Add Them**.  
   The chatbot will then be available in the channel to answer any questions you might have.

## Step 6: Start Chatting

You're all set! The SketricGen chatbot is now connected and ready to enhance collaboration within your Slack workspace.
...
![Bot Responding in Slack](/images/slack/screenshot6.png)
