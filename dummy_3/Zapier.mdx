...
![Screenshot showing Zapier dashboard with Create Zap workflow option](/images/zapier/screenshot3.png)
...
![Screenshot showing Zapier workflow configuration with SketricGen integration, Prompt Message, Agent ID, and Conversation ID fields](/images/zapier/screenshot8.png)
