...
![io_structured_io.png](/images/user-guides/structured-input-output/io_structured_io.png)
...
- Always define **Structured Inputs** for downstream agents—this prevents data mismatch during orchestration.
...
![io_structured.gif](/images/user-guides/structured-input-output/io_structured.gif)
