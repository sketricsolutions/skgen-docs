...
description: "Best practices for building multi-agent workflows in SketricGen — control flow, handoff design, structured I/O, tool usage, and orchestration patterns."
---
