Build your AgentSpace like a team: a **Manager/Triage** agent receives the message first, decides what’s needed, and **passes control** to the right specialist. Your job is to make control flow **predictable** with clear instructions and tool usage notes. [OpenAI CDN](https://cdn.openai.com/business-guides-and-resources/a-practical-guide-to-building-agents.pdf)
...
- Avoid forcing intermediate agents to emit final JSON unless they’re the responder.
