---
title: "AgentSpace Canvas"
description: "Design multi-agent workflows visually on the AgentSpace canvas — add agents, connect handoffs, attach tools, import/export configs, and test in the Playground."
---
