---
title: "AgentSpace"
description: "Design multi-agent workflows visually on the AgentSpace — add agents, connect handoffs, attach tools, import/export configs, and test in the Playground."
keywords: ["AgentSpace", "visual workflow", "drag-and-drop", "multi-agent orchestration"]
---

![AgentSpace hero image showing the visual drag-and-drop interface for building multi-agent workflows](/images/user-guides/agent-space/canvas_hero.png)

## Overview

The AgentSpace is the central workspace of SketricGen — a visual workspace where you design, test, and optimize multi-agent workflows.
...
On the top-left corner of the AgentSpace is the Add Node menu, where you can choose what to add to your workflow.
...
## Agents and Tools on the AgentSpace

Each agent you place on the AgentSpace represents a distinct role in your workflow.
...
Lina (Triage Agent) handles basic queries and meeting scheduling and hands off technical questions to Alex (Product Specialist) for product-specific questions; Alex uses File Search for accurate responses.
...
- **Designer-Routed Handoffs:** You define explicit paths and conditions. Specify clearly in the Instructions of Router Agent that it must never respond to the questions and only hand-off as per your conditions.
...
## AgentSpace Controls and Layout Tools
...
| Zoom In / Zoom Out | Adjusts the AgentSpace scale.                        |
...
![Animated GIF showing AgentSpace layout management with zoom, pan, and node organization features](/images/user-guides/agent-space/canvas_layout.gif)
...
- [Traces & Optimizations →](/user-guides/traces-and-optimizations)
