---
title: "Traces & Optimization"
description: "Inspect agent reasoning, tool calls, handoffs, latency, and credit consumption with the Trace Explorer — debug and optimize your AI workflows."
---
...
- The system automatically retries tool calls on failure (once or twice), but there is no user-facing retry or fallback configuration.
- Keep sensitive credentials secure; rotate API keys periodically.
