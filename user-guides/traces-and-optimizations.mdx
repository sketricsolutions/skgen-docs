...
sidebarTitle: "Traces"
icon: "activity"
description: "Use SketricGen traces to inspect AI Workforce runs, sub-agent calls, tool calls, latency, credit usage, generated files, artifacts, and errors."
keywords: ["traces", "agent runs", "AI Workforce", "agentic workflow", "artifacts", "tool calls", "optimization"]
---
...
For related setup, see [AI Workforce Tools, Connectors, and Skills](/user-guides/tools), [Runs, Schedules, Files, and Artifacts](/ai-workforce/runs-files-artifacts), and [Multi-Agent Orchestration and Handoffs](/user-guides/orchestration-and-handoffs).
