...
description: "Fine-tune AI agent behavior with Temperature, Top P, and model-specific settings like Reasoning Effort and Verbosity for GPT-5.2 in SketricGen."
---
...
5. **Consider downstream agents** — If your agent hands off to another agent, lower verbosity (on GPT-5.2) keeps context manageable.

6. **Monitor costs** — Higher reasoning effort and more complex models increase token usage and costs.
