...
![orch_hero.png](/images/user-guides/orchestration-handoffs/orch_hero.png)
...
In the backend, this is represented internally as a **tool call** (e.g., `transfer_to_specialist_agent`).

Typically, the final agent in the chain generates the conversation’s output.

**Characteristics**

- Passes control permanently until another handoff occurs.
...
![orch_agent_as_tool.png](/images/user-guides/orchestration-handoffs/orch_agent_as_tool.png)
...
- Use **Structured Outputs (JSON)** on final responder agents to ensure consistent downstream or API responses.
...
![orch_trace.png](/images/user-guides/orchestration-handoffs/orch_trace.png)
...
![orch_handoff.gif](/images/user-guides/orchestration-handoffs/orch_handoff.gif)
