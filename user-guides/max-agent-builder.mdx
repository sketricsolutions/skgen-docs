...
description: "Build multi-agent workflows from a conversation. Max gathers your requirements, suggests apps, and wires everything on the canvas for you."
---
...
Max - Agent Builder (referred to as "Max" throughout this guide) is an AI-powered workflow builder that turns a natural-language conversation into a fully wired multi-agent workflow on your AgentSpace canvas.
...
You can also skip Max and edit the workflow manually at any time — update instructions, reconfigure tools, or adjust handoffs directly on the canvas.
