...
| Knowledge Bases | Ground agents in approved information | Website crawl, supported files, pasted text, Q&A, synced Notion pages | Searchable knowledge sources and retrieved context |
