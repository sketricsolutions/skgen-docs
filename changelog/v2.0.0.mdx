---
title: "SketricGen v2.0.0"
description: "SketricGen v2.0.0 release notes — major platform update with multi-agent orchestration, AgentSpace, app marketplace, and deployment integrations."
---
...
This release introduces **AgentSpace**, a visual workspace that lets users design complex workflows of interconnected agents, tools, and triggers — all within a no-code environment.
...
- Manage versions, promote drafts to production, and test directly from the AgentSpace.
