...
description: "SketricGen v2.0.0 release notes — major platform update with multi-agent orchestration, AgentSpace canvas, app marketplace, and deployment integrations."
---
